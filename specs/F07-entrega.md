...
- `docs/guion_oral.md`, con tiempos: 0:00 qué problema resuelve (30 s) · 0:30 demo: arrancar y ver el aviso de alertas, registrar una salida que dispara alerta, intentar una salida inválida, alertas, indicadores, gráfico (2:30) · 3:00 código: el diagrama de capas de la guía, recorrer `modelos.py` e `inventario.registrar_movimiento` y un test (1:00) · 4:00 uso de IA: una decisión aceptada y una rechazada (30 s) · 4:30 cierre y preguntas.
