...
- `try/except` en los bordes: archivos en `persistencia.py`, conversión de `input` en `main.py`, `ErrorInventario` en las `opcion_*` de `main.py`. Nunca `except:` a secas ni `except Exception`.
