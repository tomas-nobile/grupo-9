...
8. Armar el ZIP en la carpeta padre con **solo**: `main.py`, `inventario.py`, `modelos.py`, `persistencia.py`, `analisis.py`, `analisis.ipynb`, `datos/`, `graficos/`, `tests/`, `requirements.txt`, `README.md`, `docs/guia.md`, `docs/registro_prompts.md`. Sin `.venv`, `__pycache__`, `.git`, `.claude`, `specs/`.
